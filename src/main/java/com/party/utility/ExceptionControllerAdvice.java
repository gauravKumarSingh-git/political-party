...
public class ExceptionControllerAdvice {
	...
	public ResponseEntity<ErrorInfo> womenEmpExceptionHandler(PartyException exception) {
		ErrorInfo error = new ErrorInfo();
		error.setErrorMessage("Error check logs for more info");
